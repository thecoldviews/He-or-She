package com.example.dd;// Wav file IO class
// A.Greensted
...
//		}
	...
	// Integer
	// -------
	public int readFrames(byte[] sampleBuffer, int numFramesToRead) throws IOException, WavFileException
	{
		return readFrames(sampleBuffer, 0, numFramesToRead);
	}

	public int readFrames(byte[] sampleBuffer, int offset, int numFramesToRead) throws IOException, WavFileException
	{
		...
		for (int f=0 ; f<numFramesToRead ; f++)
		{
			...
			{
				sampleBuffer[offset] = (byte) readSample();
				offset ++;
			}
